...
namespace Gatos_E_Sopas.Models
{
    public class BaseDados
    {
        ...
        public BaseDados()
        {
            ...
            strLigacao = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|datadirectory|\BD_GatosSopas.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        // Metodo para iniciar uma tranasação
        ...
        // Metodo para executar a instrrução de SQL com uma transação
